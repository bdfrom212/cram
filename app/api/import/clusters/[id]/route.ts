...
export async function PATCH(
  ...
  const { canonical_name, individuals, instagram, status, notes, raw_strings, event_count, role, primary_firm_id, entity_type } = body
  ...
  if (primary_firm_id !== undefined) updateFields.primary_firm_id = primary_firm_id
