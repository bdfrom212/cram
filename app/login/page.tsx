  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-10 w-full max-w-sm text-center">
        <h1 className="text-2xl font-semibold text-gray-900 mb-1">cram</h1>
        <p className="text-gray-500 text-sm mb-8">Relationship intelligence for wedding photographers</p>
        <button
          onClick={signIn}
